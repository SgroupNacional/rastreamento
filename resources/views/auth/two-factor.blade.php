...
<html lang="en">
	...
	<body id="kt_body" class="app-blank">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
						...
						<div class="w-lg-500px p-10">
							...
							<form class="form w-100 mb-13" novalidate="novalidate" data-kt-redirect-url="index.html" id="kt_sing_in_two_factor_form">
								...
								<div class="text-center mb-10">
									<img alt="Logo" class="mh-125px" src="{{ asset('metronic/assets/media/svg/misc/smartphone-2.svg') }}" />
								</div>
								<!--end::Icon-->
								<!--begin::Heading-->
								<div class="text-center mb-10">
				...
				<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url('{{ asset('metronic/assets/media/misc/auth-bg.png)">
					...
					<div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
						...
						<!--end::Logo-->
						<!--begin::Image-->
						<img class="d-none d-lg-block mx-auto w-275px w-md-50 w-xl-500px mb-10 mb-lg-20" src="{{ asset('metronic/assets/media/misc/auth-screens.png') }}" alt="" />
						<!--end::Image-->
						<!--begin::Title-->
		...
		<script src="{{ asset('metronic/assets/js/custom/authentication/sign-in/two-factor.js') }}"></script>
